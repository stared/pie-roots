...
- \*sed-: a nine-door tree — no other root enters English through so many independent doors (OE, Norse, French/Latin, Greek coinage, Latin-carried Greek, Irish, Welsh, German, Hebrew-mediated Greek, Sanskrit), plus the PIE-age compound *nisdós 'nest' arriving twice: once by blood (nest), once by borrowing (eyas, niche).
