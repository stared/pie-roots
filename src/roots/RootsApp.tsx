...
const VIEWS: View[] = [
  ...
  },
  {
    ...
    title: <><i>*weyd-</i> <span className="means">means</span> to see, to know</>,
    dek: <>To see meant to know — and the root followed that turn into foresight and hidden knowledge: <b>wizard</b>, <b>clairvoyant</b> ‘clear-seeing’, <b>Hades</b> ‘the Unseen’, and the <b>Veda</b>. Polish kept the see–know link especially close: <b>widzieć</b> ‘to see’ sits one letter from <i>wiedzieć</i> ‘to know’, while <b>wiedźma</b> ‘witch’ and <b>wieszcz</b> ‘poet-prophet’ are still ones-who-know.</>,
    chart: <Know />,
    dark: true,
  },
  {
