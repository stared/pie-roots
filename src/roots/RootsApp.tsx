...
interface View {
  ...
  slug: string;
  /** this root's section anchor in root_trees.md on GitHub */
  trees: string;
  title: ReactNode;
  dek: ReactNode;
  chart: ReactNode;
...
const VIEWS: View[] = [
  {
    slug: "weyd",
    trees: "weyd--to-see--to-know-full-descent-tree",
  ...
  {
    slug: "weyd-magic",
    trees: "the-knowing-side-secret-knowledge-subset-audited-2026-07-15",
  ...
  {
    slug: "sed",
    trees: "sed--to-sit-full-descent-tree",
  ...
  {
    slug: "kwel",
    trees: "kʷelh--to-turn-move-around-dwell",
    ...
    <div className={share ? "roots share" : "roots"}>
      ...
      {share ? (
        ...
        <footer className="credit">
          ...
          <span><svg width="12" height="13"><circle cx="6" cy="7" r="4" fill="none" className="t-ring" strokeDasharray="2 2" /></svg> reconstructed</span>
          <span><svg width="20" height="13"><line x1="1" y1="7" x2="19" y2="7" className="t-link" strokeDasharray="5 4" /></svg> disputed step</span>
          <span className="by">sources: Wiktionary, Etymonline · <a href={`https://github.com/stared/pie-roots/blob/main/root_trees.md#${view.trees}`}>full descent tree</a> · <a href="?share">poster version</a></span>
        </footer>
      )}
    </div>
  );
