...
export const RIPPLE_NODES: RippleNode[] = [
  ...
  { id: "aphasia_gr", form: "ἀφασία", gloss: "speechlessness", lang: "Greek", kind: "ancestor", a: -34.5, g: 2.7, parent: "phasis" },
  ...
  { id: "telephone", form: "telephone", kind: "modern", a: -26, g: 3, parent: "phone" },
  { id: "phones", form: "phone", kind: "modern", a: -26, g: 4, parent: "telephone" },
  ...
  { id: "fata", form: "Fāta", gloss: "the Fates", lang: "Latin", kind: "ancestor", a: -11, g: 3, parent: "fatum" },
  { id: "fate", form: "fate", kind: "modern", a: -13, g: 4, parent: "fata" },
  { id: "fae", form: "fae", gloss: "fay", lang: "Old French", kind: "ancestor", a: -9, g: 4, parent: "fata" },
  ...
  { id: "infante", form: "infante", gloss: "youth; foot soldier", lang: "Italian", kind: "ancestor", a: 5, g: 3, parent: "infans" },
  ...
  { id: "nefas", form: "nefās", gloss: "what may not be spoken", lang: "Latin", kind: "ancestor", a: 15, g: 3.5, parent: "fas" },
  ...
  { id: "fateri", form: "fatērī", gloss: "to avow", lang: "Latin", kind: "ancestor", a: 20, g: 2.7, parent: "fari" },
  ...
  { id: "banir", form: "banir", gloss: "to banish", lang: "Old French", kind: "ancestor", a: 25.5, g: 3.55, parent: "bannjan" },
  { id: "banish", form: "banish", kind: "modern", a: 23, g: 4.5, parent: "banir" },
  { id: "frankban", form: "*ban", gloss: "command under penalty", lang: "Frankish", kind: "proto", a: 42, g: 1.85, parent: "bannana", labelLeft: true },
  { id: "banof", form: "ban", gloss: "feudal jurisdiction", lang: "Old French", kind: "ancestor", a: 37, g: 2.9, parent: "frankban" },
  { id: "banal", form: "banal", kind: "modern", a: 32.5, g: 4.15, parent: "banof" },
  { id: "bandon", form: "bandon", gloss: "power; (a bandon) at one’s will", lang: "Old French", kind: "ancestor", a: 35.5, g: 4.3, parent: "banof" },
  { id: "abandon", form: "abandon", kind: "modern", a: 35.5, g: 5.1, parent: "bandon" },
  ...
  { id: "bannire", form: "bannīre", gloss: "to proclaim, outlaw", lang: "Late Latin", kind: "ancestor", a: 29, g: 3.8, parent: "bannjan" },
  { id: "bandito", form: "bandito", gloss: "proclaimed, outlawed", lang: "Italian", kind: "ancestor", a: 29, g: 4.5, parent: "bannire", dashed: true },
  { id: "bandit", form: "bandit", kind: "modern", a: 29, g: 5.35, parent: "bandito" },
  { id: "boniz", form: "*bōniz", gloss: "a spoken plea", lang: "Proto-Germanic", kind: "proto", a: 52, g: 1 },
