...
export const RIPPLE_NODES: RippleNode[] = [
  ...
  { id: "prophetes", form: "προφήτης", note: "who speaks forth · Greek", kind: "ancestor", a: -48, g: 2.2, parent: "phemi" },
  { id: "prophet", form: "prophet", kind: "modern", a: -48, g: 3.4, parent: "prophetes" },
  { id: "euphemos", form: "εὔφημος", note: "fair-spoken · Greek", kind: "ancestor", a: -29.5, g: 2.6, parent: "phemi" },
  ...
  { id: "fama", form: "fāma", note: "talk, repute · Latin", kind: "ancestor", a: -4.5, g: 2, parent: "fari" },
  ...
  { id: "praefatio", form: "praefātiō", note: "Latin", kind: "ancestor", a: -2, g: 2.7, parent: "fari" },
