...
export const SED_NODES: SedNode[] = [
  ...
  { id: "kathedra", form: "καθέδρα", gloss: "seat, chair", lang: "Greek", kind: "ancestor", x: 1600, y: 640, parent: "hedra" },
  { id: "cathedra", form: "cathedra", gloss: "chair; bishop’s seat", lang: "Latin", kind: "ancestor", x: 1590, y: 765, parent: "kathedra" },
  { id: "chaiere", form: "chaiere", gloss: "chair, throne", lang: "Old French", kind: "ancestor", x: 1580, y: 880, parent: "cathedra" },
  ...
  { id: "beansidhe", form: "bean sí", gloss: "woman of the mound", lang: "Irish", kind: "ancestor", x: 1780, y: 910, parent: "sid" },
