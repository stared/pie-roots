...
export const SED_NODES: SedNode[] = [
  ...
  { id: "setzen", form: "setzen", note: "to set → ersetzen ‘to replace’ · German", kind: "ancestor", x: 406, y: 870, parent: "satjana" },
  { id: "ersatz", form: "ersatz", kind: "modern", x: 406, parent: "setzen" },
  ...
  { id: "nestaz", form: "*nestaz", note: "← *ni-sd-ós ‘the sit-down’ · Proto-Germanic", kind: "proto", x: 590, y: 350 },
  ...
  { id: "nidus", form: "nīdus", note: "← *ni-sd-ós ‘the sit-down’: nest · Latin", kind: "ancestor", x: 1335, y: 600 },
  ...
  { id: "nidicare", form: "nīdicāre", note: "to nest · Italian → French", kind: "ancestor", x: 1380, y: 780, parent: "nidus", dashed: true },
  ...
  { id: "chaiere", form: "chaiere", note: "← cathedra · Old French", kind: "ancestor", x: 1580, y: 880, parent: "kathedra" },
  ...
  { id: "sanhedrin_he", form: "sanhedrīn", note: "Hebrew ← Greek", kind: "ancestor", x: 1680, y: 850, parent: "synedrion" },
